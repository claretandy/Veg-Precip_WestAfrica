...
print(
    levelplot(mycl.1bf, att="Landcover", maxpixels=600000, main="Afternoon (16-18Z) MCS Initiations Over Vegetation Classes", xlim=c(-18,11), ylim=c(4,20), xlab=NULL, ylab=NULL, col.regions=as.character(ftab$Colours)) + # scales=list(draw=FALSE), xlim=c(-3,10), ylim=c(12,20)
